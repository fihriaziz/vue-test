<template>
  <Auth>
    <div class="w-2/3 mx-auto p-5 pl-0 sm:p-20 mt-16 sm:mt-0">
        <h3 class="text-xl sm:text-2xl font-semibold text-center text-black dark:text-white sm:text-left">Edit Bonus</h3>
            <form class="bg-slate-300 dark:bg-gray-800 p-8 rounded-md shadow-md mt-5" @submit.prevent="updateBonus()">
